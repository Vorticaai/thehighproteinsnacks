...
type SnackFinderClientProps = {
  products: Product[]
}

export default function SnackFinderClient({ products }: SnackFinderClientProps) {
  ...
  const recommendations = showResults
    ? getRecommendedSnacks(products, answers)
    : []
    ...
    <>
      ...
      <header className="mb-10 text-center">
        ...
        <p className="mx-auto max-w-2xl text-lg text-gray-600">
          Answer a few quick questions and we&apos;ll recommend high-protein
          snacks that match your goals, calories, and diet tags.
        </p>
      </header>
      ...
      {!showResults ? (
              ...
              <div>
                ...
                <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-4">
                  {[
                    ...
                    {
                      value: "pre-workout" as SnackTime,
        ...
        <div className="space-y-8">
          ...
          <div className="text-center">
            <p className="mb-4 text-gray-600">Want to explore more options?</p>
            <Link
